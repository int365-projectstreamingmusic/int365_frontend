<template>
      ...
      <div class="lg:mx-10 md:w-698 sm:w-466 w-80">
        <div class="flex flex-row relative">
          <div class="absolute flex flex-row items-end z-10 justify-between  md:w-698 sm:w-466 w-80"
            ...
            <div
              class="absolute  md:pl-5 sm:pl-4 pl-2 md:pb-5 pb-3 text-white md:text-6xl text-3xl font-sansation-bold ">1
            </div>
            <div v-if="topOne"
  ...
  <div v-show="authenticated" :class="recentplayed == '' ? '' : 'bg-blackcoal'"
    ...
    <div v-if="recentplayed != '' && recentplayed == 'NOTFOUNDRP' && notfoundRP"
      ...
      <div class="font-sansation-bold  text-white mb-3 xgl:text-4xl md:text-2xl text-xl mt-3">" Not have Recent Played
        In History "</div>
    </div>
    <div v-if="recentplayed != '' && recentplayed != 'NOTFOUNDRP' && !notfoundRP"
      class="2xl:w-1200 xgl:w-962 md:w-698 sm:w-466 w-80">
